...
for i = 1:20
    ...
    pcaScore = testFilePCAScores12th{i,1};
    ...
    dX = pcaScore(73:144,1);
    aveDX = mean(dX);
    dY = pcaScore(73:144,2);
    aveDY = mean(dY);
    dZ = pcaScore(73:144,3);
    aveDZ = mean(dZ);

    vX = pcaScore(145:216,1);
    aveVX = mean(vX);
    vY = pcaScore(145:216,2);
    aveVY = mean(vY);
    vZ = pcaScore(145:216,3);
    aveVZ = mean(vZ);
