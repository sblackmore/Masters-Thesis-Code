...
function testFileProbabilities = process_test_files_PCA_6th_plot
...
% squares line
[m,p,s] = best_fit_line(correctMat6(:,1),correctMat6(:,2),correctMat6(:,3));

% get get the mins
minX = min(correctMat6(:,1));
...
for i = 1:20
    ...
    pcaScore = testFilePCAScores6th{i,1};
    ...
    vX = pcaScore(73:108,1);
    aveVX = mean(vX);
    vY = pcaScore(73:108,2);
    aveVY = mean(vY);
    vZ = pcaScore(73:108,3);
    aveVZ = mean(vZ);
